    ...
    <div class="card">
        <div class="card-body">
            <form action="/simpan_nilai" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="berkas" class="form-label">Berkas (PDF/DOC, dll.) *opsional</label>
                    <input type="file" name="berkas" id="berkas" class="form-control" accept=".pdf,.doc,.docx,.ppt,.pptx,.xls,.xlsx,.txt">
                </div>
